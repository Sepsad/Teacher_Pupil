...
const teachingInstructions = {
    ...
    pages: [
        `<div class="instructions">
            ...
            '<img src="https://raw.githubusercontent.com/Sepsad/Teacher_Pupil/refs/heads/production_php_pupil/images/Pupil_board.png" style="padding: 1rem; text-align: center" class = "img-fluid">'
        </div>`,
        `<div class="instructions">
            <h2>Remember</h2>
